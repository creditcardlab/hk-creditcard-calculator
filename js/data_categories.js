...
const categoriesDB = {
    ...
    travel_ticket: { label: "🎫 旅遊預訂平台", order: 14.1, parent: "travel" },
    ...
    // Legacy compatibility bucket; hidden from dropdown.
    chill_merchant: { label: "🎟️ Chill 指定商戶（按官方名單）", order: 110, req: "boc_chill", hidden: true },
    go_merchant: { label: "🛍️ Go 指定商戶（按官方名單）", order: 111, req: (cards) => cards.includes("boc_go_diamond") || cards.includes("boc_go_platinum"), hidden: true },
    sogo_merchant: { label: "🛍️ SOGO 指定商戶/產品（5%）", order: 112, req: "boc_sogo", hidden: true },
    ae_online_travel_designated: { label: "✈️ AE 指定網上旅遊商戶", order: 113, req: "ae_explorer", parent: "online", hidden: true },
    ae_online_designated: { label: "🛒 AE 指定網上商戶（5X）", order: 114, req: "ae_explorer", parent: "online", hidden: true },
    ae_plat_travel_designated: { label: "✈️ AE 白金指定旅遊商戶（+7X）", order: 115, req: "ae_platinum", hidden: true },
    ae_plat_daily_designated: { label: "🛒 AE 白金指定日常商戶（+7X）", order: 116, req: "ae_platinum", hidden: true },
    ae_pcc_designated: { label: "🏬 AE 大頭指定商戶（Double Points）", order: 117, req: "ae_platinum_credit", hidden: true },
